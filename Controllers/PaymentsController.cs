...
namespace WebApplication_Deneme.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Payments.Include(p => p.Package).Include(p => p.User);
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,PackageId,PaymentDate,Amount")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,PackageId,PaymentDate,Amount")] Payment payment)
        {
            if (id != payment.Id)
            {
                return NotFound();
